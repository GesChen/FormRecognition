...
Excel template columns. One file per `form_type`, stored as `data/xlsx/mappings/<xlsx_template_name>/<form_type>.json`.
...
5. **Save** the file as `data/xlsx/mappings/<xlsx_template_name>/<form_type>.json`
   (e.g. `data/xlsx/mappings/2026 template ver 1/6post.json`).
